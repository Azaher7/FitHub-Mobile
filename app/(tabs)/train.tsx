          ...
          <View style={styles.splitRow}>
            {workoutSplits.map((split) => (
              <Pressable
                ...
                style={({ pressed }) => [styles.splitChip, selectedSplit?.id === split.id && styles.splitChipActive, selectedSplit?.id === split.id && styles.splitChipGlow, pressed && styles.pressed]}>
        ...
        <Card>
          ...
          {selectedSplit?.workouts.map((workout) => (
            <Pressable
              ...
              style={({ pressed }) => [styles.workoutCard, selectedSplit.workouts[0]?.id === workout.id && styles.activeWorkoutCard, pressed && styles.workoutCardPressed]}>
